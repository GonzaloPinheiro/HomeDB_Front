...
export async function getMyPermissions(): Promise<UserModulePermissionsDto> {
  const res = await apiClient.get<ApiResponse<UserModulePermissionsDto>>('/api/users/me/permissions');
